...
![테스트이미지](/assets/images/test.jpg)

---

## 🔬 주요 프로젝트 및 연구 목록

### 1. AI 기반 개인 맞춤형 교육 서비스 UX 디자인 연구

- **역할:** 주 연구원, UX 디자이너  
- **기간:** 2024.03 – 2024.08

인공지능 추천 시스템을 활용한 교육 플랫폼의 학습 경험을 개선하기 위한 연구입니다. 정성/정량 리서치를 수행하여 페르소나를 도출하고, 사용자 여정 지도(User Journey Map)를 기반으로 핵심 기능을 재설계했습니다.

#### 핵심 기여 및 성과
- 재설계된 프로토타입의 A/B 테스트에서 사용자 만족도 **15% 향상** 달성
- 사용자 리서치 결과를 바탕으로 3가지 핵심 기능의 우선순위 설정
- **사용 도구:** Figma, Miro, SPSS (통계 분석)

➡️ [프로젝트 상세 보고서 보기](project1_detail.md)

---

### 2. 모바일 금융 앱 사용성 평가 및 개선
...
#### 핵심 기여 및 성과
- 발견된 12가지 주요 사용성 문제 중 8가지에 대한 해결책을 개발팀에 제안
- 복잡한 메뉴 구조를 단순화하는 정보 구조(IA) 개편안 제시
- **사용 도구:** Adobe XD, Usability Testing (Think-aloud protocol)
...
- **GitHub:** [hyunhwa](https://github.com/GildongDev)  
- **LinkedIn:** [hyunhwa](https://linkedin.com/in/GildongHong)
